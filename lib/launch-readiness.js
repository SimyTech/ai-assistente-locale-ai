import { validPublicHttpsUrl } from "./public-url.js";
...
export function readinessChecks(env = process.env) {
  ...
  // account recovery and email verification. A partial or unsafe Resend setup
  // must not be reported as production-ready.
