...
const CONVERSATIONAL = /(consigli|suggerisc|\bidea\b|\bidee\b|scrivi|riscrivi|spiega|perche|come posso|cosa ne pensi|che ne pensi|mi aiuti|aiutami|chi sei|cosa sei|come funziona|raccontami|parlami|migliora|\btesto\b|messaggio|\bpost\b|caption)/;
...
export function classifyMaviIntent(message) {
  ...
  return { route: MAVI_ROUTE.QWEN, intent: "conversation", confidence: 0.68 };
}
