...
const LOCAL_INFO = /(serviz|trattament|prezz|cost|tariff|promozion|\bpromo\b|offert|orar|apert|chius|client|appuntament|impegn|programma|chi viene|chi ho|(?:ho|devo).*(?:fare|gestire).*oggi|(?:ho|devo).*oggi.*(?:fare|gestire))/;
