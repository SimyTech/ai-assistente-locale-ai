...
const LOCAL_INFO = /(serviz|trattament|prezz|cost|tariff|listino|promozion|\bpromo\b|offert|scont|orar|apert|chius|client|contatt|rubrica|appuntament|impegn|programma|agenda|giornata|chi viene|chi vedo|chi ho|come sono messo|(?:ho|devo).*(?:fare|gestire)|(?:cosa|che) (?:faccio|si fa|facciamo|c e|mi aspetta|ci aspetta|abbiamo)|(?:oggi|domani).*(?:situazione|come va)|indirizzo|dove siamo|numero di telefono)/;
